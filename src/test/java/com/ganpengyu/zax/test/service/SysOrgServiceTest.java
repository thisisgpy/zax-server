...
public class SysOrgServiceTest extends ZaxApplicationTest {
    ...
    public void testUpdateOrg() {
        ...
        org.setParentId(685010161999286272L);
        org.setName("成都天府粮仓农旅投资发展集团有限公司1");
        org.setNameAbbr("天府粮仓1");
        org.setComment("以老旅投为核心1");

        SysOrg sysOrg = sysOrgService.updateOrg(org);
        Assertions.assertEquals("00010006", sysOrg.getCode());
    }
